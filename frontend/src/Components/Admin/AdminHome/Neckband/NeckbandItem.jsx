...
function Neckbands() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingProduct) {
        await axios.put(`http://localhost:5000/api/admin/Neckbands/${editingProduct._id}`, formData);
        alert("Product updated successfully");
      } else {
        await axios.post("http://localhost:5000/api/admin/Neckbands", formData);
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get("http://localhost:5000/api/admin/Neckbands");
  ...
  const handleDelete = async (productId) => {
    try {
      await axios.delete(`http://localhost:5000/api/admin/Neckbands/${productId}`);
